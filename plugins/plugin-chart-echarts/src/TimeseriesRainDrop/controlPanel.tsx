        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              default: averageLine,
              description: t('Whether to display a average line for the chart'),
            },
          }
        ],
        [
          {
            ...
            config: {
              type: 'CheckboxControl',
              label: t('Show Min Max WaterDrop'),
              renderTrigger: true,
              default: waterdrop,
              description: t('Whether to display a maximum minimum value for the chart'),
            },
          }
        ],
        [minorTicks],
