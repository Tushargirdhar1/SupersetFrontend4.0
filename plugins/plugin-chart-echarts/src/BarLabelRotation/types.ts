...
export type BarLabelFormData = QueryFormData & {
...
export interface BarLabelChartProps
  extends BaseChartProps<BarLabelFormData> {
  formData: BarLabelFormData;
}

export type BarLabelTransformedProps =
  BaseTransformedProps<BarLabelFormData> &
  ContextMenuTransformedProps &
  CrossFilterTransformedProps & {
